...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/ongoing_anime_in_hindi_official'),
      InlineKeyboardButton('💬 Support', url='https://t.me/weeb_club_chat')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/Rarelysukuna')
    ]])
    if Config.START_PIC:
